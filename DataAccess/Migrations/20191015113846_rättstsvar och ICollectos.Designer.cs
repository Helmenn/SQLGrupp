...
namespace DataAccess.Migrations
{
    ...
    [Migration("20191015113846_rättstsvar och ICollectos")]
    partial class rättstsvarochICollectos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SQL.RättatSvar", b =>
                {
                    b.Property<int>("RättatSvarID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("RättatSvarID");

                    b.HasIndex("SvarID");

                    b.HasIndex("SvaraltID");

                    b.ToTable("RättatSvar");
                });
